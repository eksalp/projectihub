    ...
    <div className="container mx-auto py-10 px-6" id="contact">
      <div className="text-center max-w-[600px] mx-auto">
        ...
        <motion.form initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ duration: 0.3 }} className="mt-5">
          <input type="text" placeholder="Tulis Email Anda" className="rounded-tl-md rounded-bl-md rounded-tb-md sm:p-3 p-2 outline-none text-sm shadow-md sm:w-72 w-60" />
